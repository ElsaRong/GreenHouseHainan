...
public class JackSensModeAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.day_thre.setText("白天门限：" +  UIDisplay.showSensInfoListValue(sensorType, sensorItemInfo.getDayThre()) + unit);
		holder.night_thre.setText("夜间门限：" +  UIDisplay.showSensInfoListValue(sensorType, sensorItemInfo.getNightThe()) + unit);
